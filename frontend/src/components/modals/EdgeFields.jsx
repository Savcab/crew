...
export function WebhookEdgeFields({ S, T, defaults = {} }) {
  return (
    <>
      ...
      <Field id="e-transform" label="Optional transform script"
        ph="var/transforms/normalize.py" value={defaults.transform || ''}
        note="human-only; must be a regular file inside var/transforms/" />
    </>
  )
}
